...
<head>
    ...
    <title>Hello Admin | Admin Panel</title>
            ...
            <div class="right_col" role="main">
                ...
                <div class="">
                    ...
                    <div class="row top_tiles">
                        ...
                        <a href="adduser.php" target="_blank">
                        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="tile-stats">
                                <div class="icon"><i class="fa fa-plus-circle"></i>
                                </div>
                        ...
                        <a href="assigntask.php" target="_blank">
                        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="tile-stats">
                                <div class="icon"><i class="fa fa-send-o"></i>
                                </div>
                                <div class="count">ASSIGN</div>

                                <h3>And Edit Tasks</h3>
                                <p>Lorem ipsum psdea itgum rixt.</p>
                            </div>
                        </div>
                        </a>

                        <a href="employees.php" target="_blank">
                        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="tile-stats">
                        ...
                        <a href="taskstatus.php" target="_blank">
                        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="tile-stats">
                                <div class="icon"><i class="fa fa-check-square-o"></i>
                                </div>
                                <div class="count">CHECK</div>

                                <h3>Status</h3>
                                <p>And currently running tasks.</p>
                            </div>
                        </div>
                        </a>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Weekly Summary <small>Task Activities</small></h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                    <div class="row" style="border-bottom: 1px solid #E0E0E0; padding-bottom: 5px; margin-bottom: 5px;">
                                        <div class="col-md-7" style="overflow:hidden;">
                                            ...
                                            <h4 style="margin:18px">Weekly Task progress</h4>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <ul class="list-unstyled top_profiles scroll-view">
                                                <li class="media event">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <p><strong>$2300. </strong> Agent Avarage Tasks </p>
                                                        <p> <small>12 Tasks Today</small>
                                                        </p>
                                                    </div>
                                                </li>
                                                <li class="media event">
