                                    ...
                                    ?>
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12 animated fadeInDown">
                                            <div class="well profile_view">
                                                <div class="col-sm-12">
                                                    <h4 class="brief"><strong><?php echo "ID: ".$row['id']; ?></strong><strong class="pull-right"><?php echo $row['fname']." ".$row['lname']; ?></strong></h4>
                                                    <div class="left col-xs-7">
                                                        <h5><strong><?php echo $row['work_field']; ?>, <?php if($row['type']==0){echo "Intern";}else{echo "Fulltime";} ?></strong></h5>
                                                        <ul class="list-unstyled">
                                                            <li><i class="fa fa-envelope"></i> <strong> Email:</strong> <?php echo $row['email']; ?></li>
                                                            <li><i class="fa fa-phone"></i> <strong> Phone:</strong> <?php echo $row['mphone']; ?></li>
                                                        </ul>
                                                    </div>
                                                    <div class="right col-xs-5 text-center">
                                                        <img src="images/picture.jpg" alt="" class="img-circle img-responsive">
                                                    </div>
                                                </div>
                                                <div class="col-xs-12 bottom text-center">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 emphasis">
                                                        ...
                                                        <a href="profile.php?id=<?php echo $row['id']?>" type="button" class="btn btn-primary btn-xs"> <i class="fa fa-user">
                                                            </i> View Profile </a>
                                                    </div>
                                                </div>
                                            </div>
...
<?php
    ...
    if(!(($page-1)<=0)){echo "<li><a href='employees.php?page=".($page-1)."'>"."Back"."</a></li>";} // Goto 1st page

    for($i=1; $i<=$total_pages; $i++){
        echo "<li><a href='employees.php?page=".$i."'>".$i."</a></li>";
    };

    if((($page+1)<=$total_pages)){echo "<li><a href='employees.php?page=".($page+1)."'>"."Next"."</a></li> ";} // Goto last page
?>
